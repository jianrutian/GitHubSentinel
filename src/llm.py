...
class LLM:
    def __init__(self):
        ...
        self.client = OpenAI(api_key=os.getenv("MOONSHOT_API_KEY"), base_url=os.getenv("MOONSHOT_API_BASE"))
    ...
    def generate_daily_report(self, markdown_content, dry_run=False):
        ...
        prompt = f"以下是项目的最新进展:\n\n{markdown_content}"
        # system角色描述
        system = "你是一名专业的GitHub项目管理助手，用户向你提供开源项目的最新进展，需根据功能进行分类，合并同类项，总结成一份markdown格式的中文简报。简报以项目名称和日期为标题，至少包含：1）新增功能；2）主要改进；3）修复问题。"
